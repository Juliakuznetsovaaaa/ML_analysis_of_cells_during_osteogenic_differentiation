...
def visualize_augmented_images(generator, num_images=5):
    ...
    for i in range(min(num_images, len(images))):
        # Преобразуем изображение в правильный формат
        img = images[i]
...
# Визуализируем тренировочные изображения (с аугментацией)
print("Train images (with augmentation):")
visualize_augmented_images(train_generator, num_images=5)

# Визуализируем тестовые изображения (без аугментации)
print("Test images (without augmentation):")
